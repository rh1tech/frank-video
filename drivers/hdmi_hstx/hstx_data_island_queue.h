...
/**
 * Returns the cumulative count of times the scanout ISR had to emit a
 * silence fallback packet because the audio ring was empty. Useful for
 * detecting producer back-pressure / decode stalls. Monotonically rises.
 */
